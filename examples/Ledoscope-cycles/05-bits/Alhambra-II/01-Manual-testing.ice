{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "1d4fc83c-d8f8-4868-b50a-36805564273b",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "range": "[4:0]",
        ...
        {
          "id": "888c1973-c0f7-4c3b-88db-62dbf00484fe",
          "type": "basic.constant",
          "data": {
            "name": "",
            "value": "8",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# Testing the 5-bits LEDoscope-cycles-zero-sys\n\n",
            "readonly": true
          },
          "position": {
            "x": -232,
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "Circuit to meassure. It takes 8 cycles for the 1-bit to  \nreach the channel input",
            "readonly": true
          },
          "position": {
            "x": -128,
        ...
        {
          "id": "492f867c-48f0-4522-b450-cd72bd1fb78d",
          "type": "c9fef16a5b6d834aab0897e33b692dde80037962",
          "position": {
            "x": 232,
            "y": -192
          },
        ...
        {
          "id": "b966cba3-610d-4baa-82d4-f56504ff589f",
          "type": "57d83b53bb9fd9dcddf1d5faffea14b1ed77031d",
          "position": {
            "x": 128,
            "y": -456
          },
        ...
        {
          "id": "7d341e38-662f-46d9-92de-05e73103799c",
      ...
      "wires": [
        {
          ...
          "target": {
            "block": "492f867c-48f0-4522-b450-cd72bd1fb78d",
            "port": "5e16dd84-a11b-4c1d-8b9f-e4042b282615"
          }
        },
        {
          "source": {
            "block": "b966cba3-610d-4baa-82d4-f56504ff589f",
        ...
        },
        {
          "source": {
            "block": "492f867c-48f0-4522-b450-cd72bd1fb78d",
            "port": "fbfebed3-72af-430a-b49e-26f16703265a"
          },
          "target": {
            "block": "1d4fc83c-d8f8-4868-b50a-36805564273b",
            "port": "in"
          },
          "size": 5
        },
        {
          "source": {
            "block": "7d341e38-662f-46d9-92de-05e73103799c",
        ...
        {
          "source": {
            "block": "888c1973-c0f7-4c3b-88db-62dbf00484fe",
            "port": "constant-out"
          },
          "target": {
            "block": "b966cba3-610d-4baa-82d4-f56504ff589f",
  ...
  "dependencies": {
    "c9fef16a5b6d834aab0897e33b692dde80037962": {
      "package": {
        "name": "Ledoscope-Cycles-zero-sys-5-bits",
        "version": "0.2",
        "description": "5-bits cycles Ledoscope. Measure the cycles it takes for a tic to arrive from the cycle 0",
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "fbfebed3-72af-430a-b49e-26f16703265a",
              "type": "basic.output",
              "data": {
                "name": "LED",
                "range": "[4:0]",
            ...
            {
              "id": "f7add9c5-42bb-403f-b99f-a9546d2a9d8d",
            ...
            {
              "id": "ed88d847-6b41-48b7-b6ae-35b48e3f5f9e",
              "type": "3af7d926cde3afe21cdcd9cd63b92cca64706653",
              "position": {
                "x": 1120,
                "y": -592
              },
            ...
            {
              "id": "7465c801-bd96-4037-bf9d-ec7f8d80e358",
              "type": "c0ff69fd32f2c86f7605d5cf4c6888509bf11b98",
              "position": {
                "x": 888,
                "y": -560
              },
          ...
          "wires": [
            ...
            },
            {
              ...
              "target": {
                "block": "f7add9c5-42bb-403f-b99f-a9546d2a9d8d",
            ...
            },
            {
              ...
              "target": {
                "block": "7465c801-bd96-4037-bf9d-ec7f8d80e358",
            ...
            },
            {
              ...
              "target": {
                "block": "ed88d847-6b41-48b7-b6ae-35b48e3f5f9e",
            ...
            },
            {
              "source": {
                "block": "7465c801-bd96-4037-bf9d-ec7f8d80e358",
                "port": "bed1ab72-edbd-4155-a2a7-1dee9771d807"
              },
              "target": {
                "block": "ed88d847-6b41-48b7-b6ae-35b48e3f5f9e",
            ...
            },
            {
              ...
              "target": {
                "block": "fbfebed3-72af-430a-b49e-26f16703265a",
                "port": "in"
              },
              "size": 5
            }
    ...
    "3af7d926cde3afe21cdcd9cd63b92cca64706653": {
      "package": {
        "name": "05-Reg",
        "version": "0.8",
        "description": "05-Reg: 5 bits Register. Verilog implementation",
        "author": "Juan González-Gómez (Obijuan)",
    ...
    "c0ff69fd32f2c86f7605d5cf4c6888509bf11b98": {
      "package": {
        "name": "syscounter-5bits",
        "version": "0.2",
        "description": "5-bits Syscounter",
        "author": "Juan González-Gómez (Obijuan)",
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "f67b8e95-ea8b-4550-977e-e940c4155ff2",
              "type": "basic.outputLabel",
              "data": {
                "name": "q",
                "range": "[4:0]",
            ...
            {
              "id": "bed1ab72-edbd-4155-a2a7-1dee9771d807",
              "type": "basic.output",
              "data": {
                "name": "q",
                "range": "[4:0]",
            ...
            {
              "id": "002bbd23-0f97-44bb-ac74-6a01273055ea",
              "type": "basic.outputLabel",
              "data": {
                "name": "q",
                "range": "[4:0]",
            ...
            {
              "id": "e887ee27-bd72-41f3-8a77-a25d71fd09e0",
              "type": "basic.inputLabel",
              "data": {
                "name": "q",
                "range": "[4:0]",
            ...
            {
              "id": "fc45baab-6f2f-4c14-b968-db1cd90dfe3d",
            ...
            {
              "id": "c69d633d-3452-409b-9d2e-ab789b6efe96",
              "type": "fa22552c59a58ea609ef6d1b1011857d3fa0c415",
              "position": {
                "x": 544,
                "y": 56
              },
          ...
          "wires": [
            ...
            {
              "source": {
                "block": "fc45baab-6f2f-4c14-b968-db1cd90dfe3d",
                "port": "4e8afe74-8f38-4873-97ee-f7585d99a4aa"
              },
              "target": {
            ...
            },
            {
              ...
              "target": {
                "block": "c69d633d-3452-409b-9d2e-ab789b6efe96",
            ...
            {
              "source": {
                "block": "f67b8e95-ea8b-4550-977e-e940c4155ff2",
                "port": "outlabel"
              },
              "target": {
                "block": "bed1ab72-edbd-4155-a2a7-1dee9771d807",
                "port": "in",
                "size": 5
              },
              "size": 5
            },
            {
              ...
              "target": {
                "block": "e887ee27-bd72-41f3-8a77-a25d71fd09e0",
                "port": "inlabel"
              },
              "size": 5
            },
            {
              "source": {
                "block": "002bbd23-0f97-44bb-ac74-6a01273055ea",
                "port": "outlabel"
              },
              "target": {
                "block": "fc45baab-6f2f-4c14-b968-db1cd90dfe3d",
    ...
    "fa22552c59a58ea609ef6d1b1011857d3fa0c415": {
      "package": {
        "name": "05-Sys-reg",
        "version": "0.8",
        "description": "05-Sys-reg: 5 bits system register. Verilog implementation",
        "author": "Juan González-Gómez (Obijuan)",
    ...
    "57d83b53bb9fd9dcddf1d5faffea14b1ed77031d": {
      "package": {
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "a2a9d814-7d23-4a19-b944-d1f2b3c91a12",
              "type": "076e4991a6a72fa34566f59fae65e81138cbffda",
              "position": {
                "x": 904,
                "y": 128
              },
          ...
          "wires": [
            ...
            },
            {
              ...
              "target": {
                "block": "a2a9d814-7d23-4a19-b944-d1f2b3c91a12",
    ...
    "076e4991a6a72fa34566f59fae65e81138cbffda": {
      "package": {
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "2a877f9e-2ef1-4336-b692-ec153f9f5007",
              "type": "43276d299252b2ff74b309e99c9d9117fd63c2bb",
              "position": {
                "x": 744,
                "y": 376
              },
            ...
            {
              "id": "d7d04de5-3193-439c-89df-ffa91d3e8b15",
              "type": "ef27646a2ca3d9f1e7811dac0fd909719b5affe1",
              "position": {
                "x": 568,
                "y": 128
          ...
          "wires": [
            ...
            },
            {
              ...
              "target": {
                "block": "d7d04de5-3193-439c-89df-ffa91d3e8b15",
                "port": "adf3a6ae-71e2-43dd-b504-c2cdbc14dab7"
              }
            },
            {
            ...
            },
            {
              ...
              "target": {
                "block": "2a877f9e-2ef1-4336-b692-ec153f9f5007",
                "port": "ca7c5f10-efb6-43f9-9364-52d751fc0bc6"
              }
            },
            {
            ...
            },
            {
              ...
              "target": {
                "block": "2a877f9e-2ef1-4336-b692-ec153f9f5007",
                "port": "e1493cee-3497-43e8-83c4-65fcadb5c96a"
              }
            }
          ]
        }
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "e1493cee-3497-43e8-83c4-65fcadb5c96a",
              "type": "basic.constant",
              "data": {
                "name": "",
                "value": "0",
            ...
            {
              "id": "58a3fb43-724f-4e52-b64a-1a8ce6b51cc4",
          ...
          "wires": [
            ...
            },
            {
              ...
              "target": {
                "block": "58a3fb43-724f-4e52-b64a-1a8ce6b51cc4",
                "port": "ca7c5f10-efb6-43f9-9364-52d751fc0bc6"
              }
            },
            {
            ...
            {
              "source": {
                "block": "e1493cee-3497-43e8-83c4-65fcadb5c96a",
                "port": "constant-out"
              },
              "target": {
                "block": "58a3fb43-724f-4e52-b64a-1a8ce6b51cc4",
