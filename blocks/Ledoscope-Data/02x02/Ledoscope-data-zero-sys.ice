{
  "version": "1.2",
  "package": {
    "name": "Ledoscope-Data-zero-sys-2x2",
    "version": "0.4",
    "description": "Data Ledoscope. 2 samples of 2bits data are taken initially, at the system clock rate",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "faeaa237-79c4-4b2b-8411-71d8e700bc4e",
        ...
        {
          "id": "da64fc98-253d-48cb-ac6e-dc94a635320a",
          "type": "basic.outputLabel",
          "data": {
            "name": "s0",
            "range": "[1:0]",
        ...
        {
          "id": "3a87ff5a-e381-4677-abe5-d219c07989a9",
          "type": "basic.output",
          "data": {
            "name": "sample",
            "virtual": true,
        ...
        {
          "id": "c508237c-2562-4258-bedb-438afd27d64f",
          "type": "basic.outputLabel",
          "data": {
            "name": "n",
            "blockColor": "fuchsia"
        ...
        {
          "id": "65b69272-98a1-4760-b3c8-666e71f483d1",
          "type": "basic.inputLabel",
          "data": {
            "name": "ch",
            "range": "[1:0]",
        ...
        {
          "id": "89e71608-402f-4435-93d0-73f7f42d8238",
          "type": "basic.input",
          "data": {
            "name": "ch",
            "range": "[1:0]",
        ...
        {
          "id": "977d55e2-820b-446a-a447-6eb212aed918",
          "type": "basic.inputLabel",
          "data": {
            "name": "n",
            "blockColor": "fuchsia"
        ...
        {
          "id": "99576ca6-9c9e-4747-99e3-351806e60013",
          "type": "basic.output",
          "data": {
            "name": "n"
          },
        ...
        {
          "id": "6c4ab065-68a0-46c9-b1ca-fd34fdb72db1",
          "type": "basic.outputLabel",
          "data": {
            "name": "n",
            "blockColor": "fuchsia"
        ...
        {
          "id": "a9c73dc7-9f95-4d9e-af02-cce716ec73f3",
          "type": "basic.output",
          "data": {
            "name": "s0",
            "virtual": true,
        ...
        {
          "id": "4bd3e430-4f82-4807-8177-92e1fa02a4e9",
          "type": "basic.inputLabel",
          "data": {
            "name": "s0",
            "range": "[1:0]",
        ...
        {
          "id": "b7797add-0d7c-4d5b-9be6-5ca25f56c86c",
          "type": "basic.outputLabel",
          "data": {
            "name": "ch",
            "range": "[1:0]",
        ...
        {
          "id": "b9f01243-2215-4902-a24a-356d0d83a1d1",
          "type": "basic.inputLabel",
          "data": {
            "name": "s1",
            "range": "[1:0]",
        ...
        {
          "id": "00abd5a5-149a-4071-a92a-8606c8da00c3",
          "type": "basic.outputLabel",
          "data": {
            "blockColor": "navy",
            "name": "load",
        ...
        {
          "id": "f1de9ea5-a5a9-4edb-9261-f9e3de4f1d81",
        ...
        {
          "id": "b15098a8-86bd-4fb2-ac39-08e25972739d",
        ...
        {
          "id": "8b1af916-967d-4d53-aeeb-4da7b2e75041",
        ...
        {
          "id": "9b03dcaf-ff78-4ec8-b5c7-a72f0a808646",
          "type": "b7f7136a87c607769a64233fd99bc12818a05746",
          "position": {
            "x": 1168,
            "y": -392
        ...
        {
          "id": "d55ef7a7-197b-484c-8690-f9cfb7412b84",
        ...
        {
          "id": "b990630a-501b-4ca1-89c1-883e8433c586",
        ...
        {
          "id": "220ef672-775f-4404-bca9-2a23a6fa5c35",
          "type": "bdd2a85e75095a0107a71364eb3a62c90d01b82d",
          "position": {
            "x": 1320,
            "y": -104
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "b15098a8-86bd-4fb2-ac39-08e25972739d",
        ...
        },
        {
          ...
          "target": {
            "block": "b990630a-501b-4ca1-89c1-883e8433c586",
        ...
        },
        {
          ...
          "target": {
            "block": "220ef672-775f-4404-bca9-2a23a6fa5c35",
            "port": "c39743c3-1b76-483c-8613-15f2782d0809"
          }
        },
        {
          ...
          "target": {
            "block": "8b1af916-967d-4d53-aeeb-4da7b2e75041",
        ...
        },
        {
          ...
          "target": {
            "block": "9b03dcaf-ff78-4ec8-b5c7-a72f0a808646",
        ...
        {
          "source": {
            "block": "89e71608-402f-4435-93d0-73f7f42d8238",
            "port": "out",
            "size": 2
          },
          "target": {
            "block": "65b69272-98a1-4760-b3c8-666e71f483d1",
            "port": "inlabel"
          },
          "size": 2
        },
        {
          "source": {
            "block": "b7797add-0d7c-4d5b-9be6-5ca25f56c86c",
            "port": "outlabel"
          },
          "target": {
            "block": "b990630a-501b-4ca1-89c1-883e8433c586",
        ...
        },
        {
          ...
          "target": {
            "block": "b9f01243-2215-4902-a24a-356d0d83a1d1",
            "port": "inlabel"
          },
          "size": 2
        },
        {
          "source": {
            "block": "da64fc98-253d-48cb-ac6e-dc94a635320a",
            "port": "outlabel"
          },
          "target": {
            "block": "d55ef7a7-197b-484c-8690-f9cfb7412b84",
        ...
        {
          "source": {
            "block": "faeaa237-79c4-4b2b-8411-71d8e700bc4e",
            "port": "outlabel"
          },
          "target": {
            "block": "d55ef7a7-197b-484c-8690-f9cfb7412b84",
        ...
        },
        {
          ...
          "target": {
            "block": "977d55e2-820b-446a-a447-6eb212aed918",
            "port": "inlabel"
          }
        },
        {
          "source": {
            "block": "c508237c-2562-4258-bedb-438afd27d64f",
            "port": "outlabel"
          },
          "target": {
            "block": "d55ef7a7-197b-484c-8690-f9cfb7412b84",
        ...
        {
          "source": {
            "block": "6c4ab065-68a0-46c9-b1ca-fd34fdb72db1",
            "port": "outlabel"
          },
          "target": {
            "block": "99576ca6-9c9e-4747-99e3-351806e60013",
            "port": "in"
          }
        },
        {
          "source": {
            "block": "00abd5a5-149a-4071-a92a-8606c8da00c3",
            "port": "outlabel"
          },
          "target": {
            "block": "8b1af916-967d-4d53-aeeb-4da7b2e75041",
        ...
        },
        {
          ...
          "target": {
            "block": "4bd3e430-4f82-4807-8177-92e1fa02a4e9",
            "port": "inlabel"
          },
          "size": 2
        },
        ...
        },
        {
          ...
          "target": {
            "block": "f1de9ea5-a5a9-4edb-9261-f9e3de4f1d81",
        ...
        },
        {
          ...
          "target": {
            "block": "3a87ff5a-e381-4677-abe5-d219c07989a9",
            "port": "in"
          },
          "size": 2
        },
        {
          ...
          "target": {
            "block": "a9c73dc7-9f95-4d9e-af02-cce716ec73f3",
            "port": "in"
          }
        }
      ]
